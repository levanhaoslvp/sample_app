...
ActiveRecord::Schema.define(version: 20_210_805_135_046) do
  ...
  create_table 'comment_hierarchies', id: false, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                      force: :cascade do |t|
    t.integer 'ancestor_id', null: false
    t.integer 'descendant_id', null: false
    t.integer 'generations', null: false
    t.index %w[ancestor_id descendant_id generations], name: 'comment_anc_desc_udx', unique: true
